export const OBJECTIVE_SESSION_CONFIG = {
  ...
  'aiprompt-2-mini-1': {
    type: 'aiprompt',
    label: '2급 미니 1회',
    title: 'AI 프롬프트엔지니어링 2급 미니 모의고사 통합 1회 (1~50번)',
    basePath: ['datasets', 'aiPromptEngineering', 'grade2-mini-1'],
    sessionProps: {
      backHref: '/aiprompt',
      lobbySubtitle: '총 50문항 / 미니 모의고사 통합 1회 (객관식 26 + 단답형 24)',
      durationSeconds: 60 * 60,
      examProfile: {
        totalPassMin: 35,
        subjects: [],
  ...
  'aiprompt-2-mini-2': {
    type: 'aiprompt',
    label: '2급 미니 2회',
    title: 'AI 프롬프트엔지니어링 2급 미니 모의고사 통합 2회 (51~100번)',
    basePath: ['datasets', 'aiPromptEngineering', 'grade2-mini-2'],
    sessionProps: {
      backHref: '/aiprompt',
      lobbySubtitle: '총 50문항 / 미니 모의고사 통합 2회 (객관식 4 + 단답형 46)',
      durationSeconds: 60 * 60,
      examProfile: {
        totalPassMin: 35,
        subjects: [],
  ...
  'aiprompt-2-mini-3': {
    type: 'aiprompt',
    label: '2급 미니 3회',
    title: 'AI 프롬프트엔지니어링 2급 미니 모의고사 통합 3회 (101~150번)',
    basePath: ['datasets', 'aiPromptEngineering', 'grade2-mini-3'],
    sessionProps: {
      backHref: '/aiprompt',
      lobbySubtitle: '총 50문항 / 미니 모의고사 통합 3회 (객관식 19 + 단답형 31)',
      durationSeconds: 60 * 60,
      examProfile: {
        totalPassMin: 35,
        subjects: [],
...
export const AIPROMPT_SESSIONS = [
  ...
  {
    id: 'aiprompt-2-mini-1',
    round: '2급 미니 모의고사 통합 1회',
    description: '미니 모의고사 통합 1회 50문항 (1급 문제 제외)',
  },
  {
    id: 'aiprompt-2-mini-2',
    round: '2급 미니 모의고사 통합 2회',
    description: '미니 모의고사 통합 2회 50문항 (1급 문제 제외)',
  },
  {
    id: 'aiprompt-2-mini-3',
    round: '2급 미니 모의고사 통합 3회',
    description: '미니 모의고사 통합 3회 50문항 (1급 문제 제외)',
  },
  {
    id: 'quiz-round-3',
    round: '개념 정리',

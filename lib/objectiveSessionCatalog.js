export const OBJECTIVE_SESSION_CONFIG = {
  ...
  'aiprompt-2-mini': {
    type: 'aiprompt',
    label: '2급 미니 모의고사',
    title: 'AI 프롬프트엔지니어링 2급 미니 모의고사 통합(1~7회차)',
    basePath: ['datasets', 'aiPromptEngineering', 'grade2-mini'],
    sessionProps: {
      backHref: '/aiprompt',
      lobbySubtitle: '총 150문항 / 미니 모의고사 1~7회차 통합 (객관식 49 + 단답형 101)',
...
export const AIPROMPT_SESSIONS = [
  ...
  },
  {
    id: 'aiprompt-2-mini',
    round: '2급 미니 모의고사 통합',
    description: '미니 모의고사 1~7회차 통합 150문항 (1급 문제 제외)',
  },
  {
    id: 'quiz-round-3',
    round: '개념 정리',

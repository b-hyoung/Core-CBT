...
export async function renderObjectivePersonalReviewPage({
  ...
  for (const row of rows) {
    ...
    const accepted = dataset.acceptedAnswersByNo.get(sourceProblemNumber);
    if (accepted) acceptedAnswersMap[newProblemNumber] = accepted;
  ...
  return (
    <Quiz
      ...
      acceptedAnswersMap={acceptedAnswersMap}
